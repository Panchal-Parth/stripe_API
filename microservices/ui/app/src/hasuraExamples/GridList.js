...
// sample data to test without hasura
const tilesData = [
  {
    id: 1,
	price: 10.00,
...
//'https://api.beseeching73.hasura-app.io/charge'
    ...
    /*var details = {
        'id':'dfvsdfsdfsdfsdfsdfsdfvalue1',
        'amount':2199,
        'email': 'raj.rama@sdf.cs'
    };*/
    var formBody = [];
    for (var property in token) {
      var encodedKey = encodeURIComponent(property);
      var encodedValue = encodeURIComponent(token[property]);
	...
	{	var name = 'rajesh'
		...
		if (this.state.cartTotal > 0)
		{
			stripeButton = <StripeCheckout
				...
				currency="USD"
				stripeKey="pk_test_XHk0TSUcuCtRqfWNZU3iaVYM"
			/>
      //pk_test_XHk0TSUcuCtRqfWNZU3iaVYM -- parth's key
      //pk_test_XNB5Gkou7mwEa8K9c9c2XFYL - RR's key
